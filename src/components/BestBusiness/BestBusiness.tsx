            ...
            <div>
                ...
                <Reveal>
                    <p className="max-w-md mt-10">
                        Con la tarjeta de crédito adecuada, puede mejorar financiera generando crédito, obteniendo recompensas y ahorrando dinero. Pero con cientos de tarjetas de crédito en el mercado.
                    </p>
                </Reveal>
                <Reveal>
                    <div className="my-8">
                    ...
                    <Reveal key={id}>
                        <div className="grid grid-flow-col gap-5 px-4 py-2 rounded-3xl group hover:bg-radialBlack">
                            ...
                            <div>
                                ...
                                <p className="text-primayDark">{description}</p>
                            </div>
                        </div>
                    </Reveal>
                ))}
