           ...
           <div className="flex-1 p-6 md:p-8">
            ...
            <Reveal>
                <p className="max-w-md mt-10">
                    Con la tarjeta de crédito adecuada, puede financiera generando crédito, obteniendo recompensas y ahorrando dinero. Pero con cientos de tarjetas de crédito en el mercado.
                </p>
            </Reveal>
           </div>
        </div>
